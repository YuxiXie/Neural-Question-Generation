...
def add_data_options(parser):
    ...
    parser.add_argument('-train_bio', default='')
    parser.add_argument('-bio_vocab', default='')
    ...
    parser.add_argument('-result_path', default='',
                        help="""Result filename (the result will be saved as
                        train.txt for train and dev.txt for dev""")
...
def add_train_options(parser):
    ...
    parser.add_argument('-resume', action='store_true', default=False,
                        help="""Load the last model in checkpoint directory""")
    parser.add_argument('-load_path', default='',
                        help="""the name of the model file to load""")
