...
SAVEPATH=${DATAHOME}/models/NQG_plus_answer
RESULTPATH=${DATAHOME}/results/NQG_plus_answer
...
python run.py \
       ...
       -layers 1 \
       -enc_rnn_size 384 -brnn -copy -answer encoder -answer_enc_rnn_size 384 -answer_brnn \
